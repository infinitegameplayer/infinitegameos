...
export async function generateMetadata({ params }: PageProps): Promise<Metadata> {
  ...
  return {
    ...
    twitter: twitterCard({
      title: `${asset.title}: Protocol`,
      description: asset.description,
      imageUrl: `${SITE}/protocols/${asset.slug}/opengraph-image`,
    }),
    alternates: {
      canonical: `${SITE}/protocols/${asset.slug}`,
      types: {
        'text/markdown': `${SITE}/markdown/protocols/${asset.slug}`,
      },
    },
  }
}
...
export default async function ProtocolPage({ params }: PageProps) {
  ...
  const breadcrumbSchema = {
    ...
    itemListElement: [
      ...
      { '@type': 'ListItem', position: 2, name: 'Protocols', item: `${SITE}/protocols` },
      {
        ...
        position: 3,
        name: asset.title,
        item: `${SITE}/protocols/${asset.slug}`,
      },
    ],
  }
  ...
  const markdownUrl = `${SITE}/markdown/protocols/${asset.slug}`
        ...
        <div className="section" style={{ paddingTop: '0' }}>
          <SectionReveal>
            ...
            >
              ...
              >
                This is a protocol, not a plugin. It installs as reference text
                that any agent or system reads directly. Use the markdown URL
                for one-shot loads, the Cursor rules file for persistent
                project context or read this page in full.
              </p>
              ...
              <div style={{ marginBottom: '1.5rem' }}>
                ...
                >
                  Direct markdown URL (Claude Code, Cursor, Codex CLI, any agent with --read)
                </p>
                <pre
                  style={{
