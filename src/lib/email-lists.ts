...
// list-aware membership layer. Mirror of the lanebelone copy
// (C:\Users\User\sites\lanebelone\src\lib\email-lists.ts). Keep the two
...
export const LISTS: ListDef[] = [
  ...
  // magnet or a purchase. Carried here so a person arriving from an IGOS email
  // sees and controls every list they are on, not just this site's.
  {
    key: 'sqhq',
    tag: 'sqhq',
    label: 'Side Quest HQ',
