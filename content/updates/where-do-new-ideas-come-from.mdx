...
Entering a domain you do not yet work in, purely to see what it holds, is a way of stocking parts for a combination you have not pictured yet. [Playgrounds of Exploration](/concepts/playgrounds-of-exploration), explored with the courage to discover what it holds, names that practice directly: curiosity-led time inside a domain, with no outcome required at entry.
