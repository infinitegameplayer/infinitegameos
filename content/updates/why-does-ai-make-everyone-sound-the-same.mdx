...
The stance behind the structure matters as much as the document. Staying the creative source while AI carries the mechanical work is its own discipline, and it is the heart of [Artful Intelligence](/concepts/artful-intelligence): working with AI as a creative collaborator, with the creativity staying yours. The related question of what a model can even see of you in the first place lives in [AI Is a Mirror, Not an Engine](/concepts/ai-is-a-mirror-not-an-engine).
