...
faq:
  ...
  - q: "How long does the daily maintenance for an AI second brain actually take?"
    a: "The daily clear takes about ten minutes and the weekly review takes about thirty. In practice this looks like the To-Do Dock cleared each day, a short Session Closeout written when a working session ends and a weekly review run to set the next week's direction. The specific implementation varies by practitioner, but the layer is not optional: without it the second brain calcifies, and with it the system compounds in the background."
---
