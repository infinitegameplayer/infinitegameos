...
What is left over for the Teacher is the work that requires Teacher presence. The pedagogical judgment about what to leave out. The intuition for which example clicks for this audience. The willingness to redesign module five after the first cohort surfaces the gap. The honest read on whether the student can actually do the thing six months later. These are aliveness, the emerging energy that moves through you when an idea or a moment feels exciting and true to you, in the Teacher's register. The bundle protects them by removing the friction that would otherwise erode them under sustained output.
