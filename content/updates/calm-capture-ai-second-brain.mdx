...
[Sovereign Capture](/concepts/sovereign-capture), catching the ideas that arrive all day while staying present to the work in front of you, names this clearly. The problem is staying present to the work while honoring the ideas that want to arrive. A quieter mind is the point. A fuller archive is the byproduct.
...
The Moves that install the release and the trust are in [the Sovereign Capture Field Guide](https://www.sidequesthq.co/products/sovereign-capture): Catch, Trust and Return as a three-step flow, then a fifteen-minute weekly sift. It's a $7 Field Guide with seven chapters, seven Moves. The practice companion to the AI Second Brain.
