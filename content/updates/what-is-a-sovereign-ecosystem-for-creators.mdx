...
faq:
  ...
  - q: "Is the Sovereign Ecosystem only for advanced practitioners?"
    a: "No. The Quick Start Guide walks the install from first software install through vault setup and AI adapter connection. The Build Sequence covers the ten sessions after that. Each session has an exit condition before the next begins. Pioneers, people at the edge of their own discovery, with the courage and aliveness to go after it and the humility to know they're always mid-journey, who already have a vault can run a Source Harvest over the repo instead of starting from the template."
  ...
  - q: "What does the Sovereign Ecosystem provide and what does the practitioner bring?"
    a: "The template is described as bone structure. It ships the directory architecture, governance scaffolding and a starting skill set. The practitioner brings the muscle. Every practitioner who forks the repo ends up somewhere different, and that divergence is the design intent rather than a gap in the template."
---
