...
1. Your jacket's context file: the lens's voice, calibration, signature moves and watch-fors
2. The jacket's charter or role contract: scope, escalation patterns, what it owns
3. The jacket's running note: live working state from prior sessions
4. The jacket's current-state dashboard or summary
5. The most recent session capture from this jacket
